...
<x-admin::form.control-group class="mt-4">
    <x-admin::form.control-group.label>@lang('beyondary-storefront::app.forms.our_story.image')</x-admin::form.control-group.label>
    @if (! empty($fields['image_url']))
        <img src="{{ $fields['image_url'] }}" alt="" class="mb-2 h-32 w-auto rounded object-cover">
