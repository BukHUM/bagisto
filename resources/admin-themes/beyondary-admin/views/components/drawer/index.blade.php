...
@pushOnce('scripts')
    ...
    >
        <div>
            ...
            >
                <div
                    class="fixed inset-0 z-[10001] cursor-pointer bg-gray-500 bg-opacity-50 transition-opacity"
                    v-show="isOpen"
                    @click="close"
                ></div>
            </transition>
            ...
            >
                <div
                    class="fixed z-[10002] bg-white shadow-xl dark:bg-gray-900"
                    :class="{
                        'inset-x-0 top-0': position == 'top',
                        'inset-x-0 bottom-0': position == 'bottom',
                        'inset-y-0 ltr:right-0 rtl:left-0': position == 'right',
                        'inset-y-0 ltr:left-0 rtl:right-0': position == 'left',
                        'max-sm:!w-full': mobileFullWidth,
                    }"
                    :style="'width:' + width"
                    v-if="isOpen"
                >
