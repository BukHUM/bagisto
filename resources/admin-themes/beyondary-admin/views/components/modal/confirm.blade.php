            ...
            >
                ...
                >
                    <div class="flex min-h-full items-end justify-center p-5 sm:items-center sm:p-0">
                        <div class="box-shadow absolute left-1/2 top-1/2 z-[999] w-full max-w-[400px] -translate-x-1/2 -translate-y-1/2 rounded-xl bg-admin-card max-md:w-[90%]">
                            <div class="flex items-center justify-between gap-2.5 border-b border-admin-border px-4 py-3 text-lg font-bold text-admin-text">
                                @{{ title }}
                            </div>

                            <div class="px-4 py-3 text-left text-admin-muted">
                                @{{ message }}
                            </div>
