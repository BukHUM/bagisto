...
<header class="sticky top-0 z-[10001] flex items-center justify-between border-b border-admin-border bg-admin-card px-2 py-2 sm:px-4 sm:py-2.5">
    <div class="flex items-center gap-1 sm:gap-1.5">
        <!-- Hamburger Menu -->
        <i
            class="icon-menu cursor-pointer rounded-md p-1.5 text-xl hover:bg-admin-surface lg:hidden sm:text-2xl"
       ...
       <!-- Notification Component -->
        ...
        <x-admin::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
            <x-slot:toggle>
                ...
                @else
                    <button class="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-admin-primary text-xs font-semibold leading-6 text-white transition-all hover:bg-admin-primary-hover focus:bg-admin-primary-hover sm:h-9 sm:w-9 sm:text-sm">
