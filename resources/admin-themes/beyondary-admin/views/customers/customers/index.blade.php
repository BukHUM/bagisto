<x-admin::layouts>
    ...
    >
        ...
        <template #header="{
            ...
            <template v-else>
                <div class="row grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] grid-rows-1 gap-1 items-center border-b px-4 py-2.5 border-admin-border min-w-full">
                    <div
        ...
        <template #body="{
            ...
            <template v-else>
                <div
                    class="row grid grid-cols-1 gap-2 md:grid-cols-[minmax(150px,_2fr)_1fr_1fr] md:gap-0 border-b px-4 py-2.5 transition-all hover:bg-admin-surface border-admin-border min-w-full"
                ...
                >
                    ...
                    <div class="flex items-center justify-between gap-x-4 ps-8 md:ps-0">
                        ...
                        <div class="flex items-center">
                            <a
                                class="icon-login cursor-pointer p-1.5 text-2xl hover:rounded-md hover:bg-admin-surface ltr:ml-1 rtl:mr-1"
                            ...
                            <a
                                class="icon-sort-right rtl:icon-sort-left cursor-pointer p-1.5 text-2xl hover:rounded-md hover:bg-admin-surface ltr:ml-1 rtl:mr-1"
