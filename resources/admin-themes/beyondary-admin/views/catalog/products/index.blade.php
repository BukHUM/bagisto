<x-admin::layouts>
    ...
    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
        <p class="font-display text-2xl font-semibold text-admin-text">
            @lang('admin::app.catalog.products.index.title')
        </p>
    ...
    >
        ...
        <template #header="{
            ...
            <template v-else>
                <div class="row grid gap-2 md:grid-cols-[2fr_1fr_1fr] grid-rows-1 items-center border-b px-4 py-2.5 border-admin-border">
                    <div
                    ...
                    >
                        @if ($hasPermission)
                            ...
                            >
                                ...
                                <span
                                    ...
                                    :class="[
                                        applied.massActions.meta.mode === 'all' ? 'peer-checked:icon-checked peer-checked:text-admin-primary' : (
                                            applied.massActions.meta.mode === 'partial' ? 'peer-checked:icon-checkbox-partial peer-checked:text-admin-primary' : ''
                                        ),
                                    ]"
                                >
                                </span>
                        ...
                        <p class="text-admin-muted">
                            <span class="[&>*]:after:content-['_/_']">
                                <template v-for="column in columnGroup">
                                    <span
                                        ...
                                        :class="{
                                            'font-medium text-admin-text': applied.sort.column == column,
                                            'cursor-pointer hover:text-admin-text': available.columns.find(columnTemp => columnTemp.index === column)?.sortable,
                                        }"
                                        @click="
                            ...
                            <i
                                class="align-text-bottom text-base text-admin-text ltr:ml-1.5 rtl:mr-1.5"
        ...
        <template #body="{
            ...
            <template v-else>
                <div
                    class="row border-b px-2 py-2.5 transition-all hover:bg-admin-surface border-admin-border sm:px-4 md:grid md:grid-cols-[2fr_1fr_1fr] md:grid-rows-1 md:gap-1.5"
                        ...
                        <div class="flex items-start justify-between gap-3">
                            <div class="flex items-start gap-2.5">
                                @if ($hasPermission)
                                    ...
                                    <label
                                        class="icon-uncheckbox peer-checked:icon-checked cursor-pointer rounded-md text-2xl peer-checked:text-admin-primary"
                                ...
                                <div class="relative flex-shrink-0">
                                    ...
                                    <template v-else>
                                        <div class="relative h-12 w-12 rounded border border-dashed border-gray-300 border-admin-border opacity-90 sm:h-16 sm:w-16">
                                ...
                                <div class="flex flex-col gap-1 flex-1">
                                    <p class="break-all text-sm font-semibold text-admin-text sm:text-base">
                                        @{{ record.name }}
                                    </p>

                                    <p class="text-xs text-admin-muted sm:text-sm">
                                    ...
                                    <p class="text-sm font-semibold text-admin-text sm:text-base">
                                    ...
                                    <div>
                                        ...
                                        <div v-else>
                                            <p
                                                class="text-xs text-admin-muted sm:text-sm"
                            ...
                            <div class="flex items-center gap-1">
                                <span
                                    class="cursor-pointer rounded-md p-1.5 text-xl transition-all hover:bg-admin-surface"
                                    :class="action.icon"
                    ...
                    <div class="hidden md:contents">
                        ...
                        <div class="flex gap-2.5">
                            ...
                            <div class="flex flex-col gap-1.5">
                                <p class="break-all text-base font-semibold text-admin-text">
                                    @{{ record.name }}
                                </p>
                        ...
                        <div class="flex gap-1.5">
                            <div class="relative">
                                ...
                                <template v-else>
                                    <div class="relative h-[60px] max-h-[60px] w-full max-w-[60px] rounded border border-dashed border-gray-300 border-admin-border opacity-90">
                        ...
                        <div class="flex items-center justify-between gap-x-4">
                            ...
                            >
                                <span
                                    class="cursor-pointer rounded-md p-1.5 text-2xl transition-all hover:bg-admin-surface max-sm:place-self-center"
                                    :class="action.icon"
                                    v-text="! action.icon ? action.title : ''"
                                    v-for="action in record.actions"
                                    @click="performAction(action)"
                ...
                >
                    <form @submit="handleSubmit($event, create)">
                        ...
                        <x-admin::modal ref="productCreateModal">
                            ...
                            <x-slot:header>
                                <p
                                    class="text-lg font-bold text-admin-text"
                            ...
                            <x-slot:content>
                                ...
                                <div v-show="attributes.length">
                                    ...
                                    >
                                        <label
                                            class="block text-xs font-medium leading-6 text-admin-text"
                                            v-text="attribute.name"
                                        >
                                        </label>

                                        <div class="flex min-h-[38px] flex-wrap gap-1 rounded-md border p-1.5 border-admin-border">
                                            <p
                            ...
                            <x-slot:footer>
                                <div class="flex items-center gap-x-2.5">
                                    ...
                                    <x-admin::button
                                        button-type="button"
                                        class="transparent-button hover:bg-admin-surface text-admin-text"
