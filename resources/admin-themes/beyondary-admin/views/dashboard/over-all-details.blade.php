...
@pushOnce('scripts')
    ...
    >
        ...
        <!-- Total Sales Section -->
        <template v-else>
            <div class="box-shadow rounded-lg bg-admin-card p-4 ">
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <div class="flex items-center gap-0.5">
                                <span
                                    class="text-base text-emerald-500"
                                    :class="[report.statistics.avg_sales.progress < 0 ? 'icon-down-stat text-red-500' : 'icon-up-stat text-emerald-500']"
                                ></span>
