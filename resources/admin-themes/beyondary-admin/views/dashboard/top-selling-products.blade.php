            ...
            <div class="border-b border-admin-border">
                ...
                >
                    <a
                        ...
                        class="flex gap-2.5 border-b p-4 transition-all last:border-b-0 hover:bg-admin-surface border-admin-border"
                    ...
                    >
                        ...
                        <div
                            v-else
                            class="relative h-[65px] max-h-[65px] w-full max-w-[65px] overflow-hidden rounded border border-dashed border-gray-300 border-admin-border opacity-90"
                        >
                        ...
                        <div class="flex w-full flex-col gap-1.5">
                            ...
                            <div class="flex justify-between">
                                <p class="font-semibold text-admin-muted">
