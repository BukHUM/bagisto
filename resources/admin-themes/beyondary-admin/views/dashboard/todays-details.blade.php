    ...
    >
        ...
        <template v-else>
            <div class="box-shadow rounded">
                <div class="flex flex-wrap gap-4 border-b border-admin-border bg-admin-card p-4 border-admin-border ">
                    <!-- Today's Sales -->
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] opacity-90">
                            <img
                        ...
                        <div class="grid place-content-start gap-1">
                            <p class="text-base font-semibold leading-none text-admin-text">
                                @{{ report.statistics.total_sales.formatted_total }}
                            </p>

                            <p class="text-xs font-semibold text-admin-muted">
                            ...
                            <div class="flex items-center gap-0.5">
                                <span
                                    ...
                                    :class="[report.statistics.total_sales.progress < 0 ? 'icon-down-stat text-red-500' : 'icon-up-stat text-emerald-500']"
                                ></span>
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <div class="flex items-center gap-0.5">
                                <span
                                    class="text-base text-emerald-500"
                                    :class="[report.statistics.total_orders.progress < 0 ? 'icon-down-stat text-red-500' : 'icon-up-stat text-emerald-500']"
                                ></span>
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <div class="flex items-center gap-0.5">
                                <span
                                    class="text-base text-emerald-500"
                                    :class="[report.statistics.total_customers.progress < 0 ? 'icon-down-stat text-red-500' : 'icon-up-stat text-emerald-500']"
                                ></span>
                ...
                <div 
                    ...
                    class="border-b border-admin-border bg-admin-card p-4 transition-all hover:bg-admin-surface border-admin-border "
                >
                    <div class="flex flex-wrap gap-4">
                        ...
                        <div class="flex min-w-[200px] flex-1 gap-2.5">
                            <div class="flex flex-col gap-1.5">
                            <!-- Customer Details -->
                                <p class="text-base text-admin-text">
                                    @{{ order.customer_name }}
                                </p>
        
                                <p class="max-w-[180px] break-words text-admin-muted">
                        ...
                        <div class="flex min-w-[180px] flex-1 items-center justify-between gap-2.5">
                            <div class="flex flex-col gap-1.5">
                             ...
                             <a :href="'{{ route('admin.sales.orders.view', ':replace') }}'.replace(':replace', order.id)">
                                <span class="icon-sort-right rtl:icon-sort-left cursor-pointer p-1.5 text-2xl hover:rounded-md hover:bg-admin-surface ltr:ml-1 rtl:mr-1"></span>
                            </a>
                        </div>
                    </div>
                </div>
