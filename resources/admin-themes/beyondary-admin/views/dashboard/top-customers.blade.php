    ...
    >
        ...
        <template v-else>
            <div class="border-b border-admin-border">
                ...
                <div
                    class="flex flex-col gap-8 border-b p-4 transition-all last:border-b-0 hover:bg-admin-surface border-admin-border"
                    ...
                    <a :href="customer.id ? '{{ route('admin.customers.customers.view', ':id') }}'.replace(':id', customer.id) : '#'">
                        <div class="flex justify-between gap-1.5">
                            ...
                            <div class="flex flex-col">
                                ...
                                <p class="text-admin-muted" v-if="customer.orders">
