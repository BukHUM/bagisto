...
@pushOnce('scripts')
    ...
    >
        ...
        <!-- Total Sales Section -->
        <template v-else>
            <div class="grid gap-4 border-b px-4 py-2 border-admin-border">
                <div class="flex justify-between gap-2">
                    <div class="flex flex-col justify-between gap-1">
                        ...
                        <!-- Total Order Revenue -->
                        <p class="text-lg font-bold leading-none text-admin-text">
                    ...
                    <div class="flex flex-col justify-between gap-1">
                        ...
                        <p class="text-right text-xs font-semibold text-admin-muted">
                            @{{ report.date_range }}
                        </p>
