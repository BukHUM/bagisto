    ...
    >
        ...
        <template v-else>
            ...
            >
                ...
                >
                    <div class="row grid grid-cols-2 gap-y-6 border-b border-admin-border bg-admin-card p-4 transition-all hover:bg-admin-surface border-admin-border  max-sm:grid-cols-[1fr_auto]">
                        <div class="flex gap-2.5">
                            ...
                            <template v-else>
                                <div class="relative h-[65px] max-h-[65px] w-full max-w-[65px] overflow-hidden rounded border border-dashed border-gray-300 border-admin-border opacity-90">
            ...
            >
                <div class="grid justify-center justify-items-center gap-3.5 px-2.5 py-10">
                    <img src="{{ bagisto_asset('images/icon-add-product.svg') }}" class="h-20 w-20 opacity-90">
