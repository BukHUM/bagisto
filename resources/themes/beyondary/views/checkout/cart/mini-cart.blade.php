...
<v-mini-cart>
    <span
        class="text-brand-dark/80 hover:text-brand-gold transition cursor-pointer"
        role="button"
        ...
        @if (core()->getConfigData('sales.checkout.mini_cart.display_mini_cart'))
            <x-shop::drawer>
                ...
                <x-slot:toggle>
                    ...
                    <span class="relative">
                        <i
                            class="fa-solid fa-cart-shopping text-xl text-brand-dark/80 hover:text-brand-gold transition cursor-pointer"
                            role="button"
                            aria-label="@lang('shop::app.checkout.cart.mini-cart.shopping-cart')"
                            tabindex="0"
                            @click="getCart"
                        ...
                        @if (core()->getConfigData('sales.checkout.my_cart.summary') == 'display_item_quantity')
                            <span
                                class="absolute -top-2 -right-2 bg-brand-gold text-white text-[10px] font-bold h-4 w-4 rounded-full flex items-center justify-center"
                                v-if="cart?.items_qty"
                            >
                                @{{ cart.items_qty }}
                            </span>
                ...
                >
                    ...
                    >
                        ...
                        <a
                            ...
                            class="mx-auto block w-full cursor-pointer rounded-sm bg-brand-gold hover:bg-[#A07644] px-11 py-4 text-center text-base font-medium text-white max-md:rounded-lg max-md:px-5 max-md:py-2 transition"
                        >
