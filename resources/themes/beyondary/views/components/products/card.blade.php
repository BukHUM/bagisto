...
@pushOnce('scripts')
    ...
    >
        <!-- Grid Card (Beyondary) -->
        <div class="product-card group w-full" v-if="mode != 'list'">
            <div class="relative overflow-hidden-image aspect-[4/5] mb-4 bg-brand-light rounded-sm">
                ...
                <span
                    class="absolute top-3 left-3 bg-brand-gold text-white text-xs font-bold px-2 py-1 uppercase tracking-wide shadow-sm"
                ...
                <span
                    class="absolute top-3 left-3 bg-brand-light text-brand-dark text-xs font-bold px-2 py-1 uppercase tracking-wide shadow-sm"
                ...
                @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                    <div class="absolute bottom-0 left-0 w-full p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300 max-lg:translate-y-0">
                        <button
                            type="button"
                            class="w-full bg-brand-dark/95 backdrop-blur-sm text-brand-light py-3 font-medium hover:bg-brand-gold transition flex justify-center items-center gap-2 shadow-lg rounded-sm disabled:opacity-50"
            ...
            <div class="text-center">
                ...
                <a
                    :href="'{{ route('shop.product_or_category.index', ':slug') }}'.replace(':slug', product.url_key)"
                    class="text-lg font-medium text-brand-dark mb-2 group-hover:text-brand-gold transition block"
                >
                    @{{ product.name }}
                </a>
                ...
                <div
                    class="flex items-center justify-center gap-2 text-brand-dark font-bold text-lg [&_.font-medium]:text-brand-dark/40 [&_.font-medium]:text-sm [&_.font-medium]:line-through"
